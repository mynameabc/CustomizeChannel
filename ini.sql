...
CREATE TABLE `client_user` (
  ...
  `number` int(11) NOT NULL DEFAULT 0 COMMENT '下单小号当日下单数量',
  ...
  `proxy_ip` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'ip',
  `proxy_port` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '端口号',
  `proxy_user` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '账号',
  `proxy_psw` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '密码',
...
insert  into `client_user`(`client_user_id`,`name`,`password`,`number`,`status`,`client_name`,`client_status`,`proxy_ip`,`proxy_port`,`proxy_user`,`proxy_psw`,`create_time`) values (1,'16568285139','HUjunnan520',0,'0','','0','218.64.149.163','6245','m0106','5522','2019-12-23 14:28:53'),(2,'16568285148','HUjunnan520',0,'0','','0','182.87.187.219','6245','m0106','5522','2019-12-23 14:30:10'),(3,'16568285150','HUjunnan520',0,'0','','0','182.99.242.7','6245','m0106','5522','2019-12-23 14:30:20'),(4,'16568285128','HUjunnan520',0,'0','','0','218.65.69.213','6245','m0106','5522','2019-12-23 14:30:33'),(5,'16568285149','HUjunnan520',0,'0','','0','218.65.69.30','6245','m0106','5522','2019-12-23 14:30:48'),(6,'16568285231','HUjunnan520',0,'0','','0','182.110.208.209','6245','m0106','5522','2019-12-23 14:30:57'),(7,'16568285131','HUjunnan520',0,'0','','0','218.64.152.29','6245','m0106','5522','2019-12-23 14:31:05'),(8,'16568285220','HUjunnan520',0,'0','','0','115.153.168.95','6245','m0106','5522','2019-12-23 14:31:14'),(9,'16568285119','HUjunnan520',0,'0','','0','115.153.167.201','6245','m0106','5522','2019-12-23 14:31:24'),(10,'16568285122','HUjunnan520',0,'0','','0','182.99.251.165','6245','m0106','5522','2019-12-23 14:31:38');
...
insert  into `goods`(`id`,`goods_id`,`url`,`pay_amount`,`create_time`) values (1,'A0006630274-pop8013103891','http://item.m.gome.com.cn/product-A0006630274-pop8013103891.html','15300','2019-12-23 20:12:24'),(2,'A0006631091-pop8013099491','http://item.m.gome.com.cn/product-A0006631091-pop8013099491.html','9000','2019-12-23 20:12:44'),(3,'A0006629010-pop8013098723','http://item.m.gome.com.cn/product-A0006629010-pop8013098723.html','15200','2019-12-23 20:13:00'),(4,'A0006629123-pop8013104277','http://item.m.gome.com.cn/product-A0006629123-pop8013104277.html','150000','2019-12-23 20:13:15'),(5,'A0006631151-pop8013104275','http://item.m.gome.com.cn/product-A0006631151-pop8013104275.html','6000','2019-12-23 20:13:32'),(6,'A0006629183-pop8013098950','http://item.m.gome.com.cn/product-A0006629183-pop8013098950.html','15600','2019-12-23 20:13:50');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ip许可表';
...
CREATE TABLE `pay_order` (
  ...
  `channel` varchar(35) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '充值渠道',
  `user_name` varchar(35) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '下单小号',
  `password` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '下单小号密码',
  `goods_url` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品URL',
  ...
  `amount` varchar(35) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单金额(单位:分)',
  `pay_url` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '支付订单url',
  `client_order_status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客户端订单状态(0:成功, 1:没货, 2:账号次数达到上限, 9:未知状态<其实是空字符串>)',
  `status` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '订单状态(1:支付连接生成成功, 3:支付连接生成失败, 4:请求超时, 5:支付成功(收到回调), 6:前线返回未知状态, 7:确认收货)',
...
insert  into `system_config`(`config_id`,`name`,`value`,`description`,`create_time`) values (1,'privateKey','52A1B74DDAFC4274992E51DDCDFCCD9F','私钥','2019-12-29 21:44:12'),(2,'superiorLimit','20','小号每日下单量','2019-12-29 21:47:17'),(3,'payOrderStatus','1','下单开关(0:关, 1:开)','2019-12-30 20:31:45'),(4,'heartBeatStatus','1','心跳开关(0:关, 1:开)','2020-01-04 18:11:15');
